...
def generate_authorization_header_string(
    request_data: dict, realm: str = "limited_poa"
) -> str:
    """
    ...
    """
    authorization_header_string = f'OAuth realm="{realm}", ' + ", ".join(
